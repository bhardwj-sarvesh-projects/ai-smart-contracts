...
`;
  ...
  private static scheduleBackgroundCertificationJobs(
    _project: StructuredProjectOutput,
    _options: PipelineExecutionOptions,
    _context: PipelineContext
  ): void {
    // Authoritative pipeline owns all certification ordering. Background jobs that
    // mutate project.files after return can invalidate hashes, manifests and evidence.
    return;
  }
}
